...
def windowHandler(root):
    topFontSize = int(18 // calculateFont(root))
    fontSize = int(10 // calculateFont(root))
    ...
    ft = tkFont.Font(family='Times', size=topFontSize)
